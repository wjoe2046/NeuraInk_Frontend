    ...
    >
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center mb-5">
          <p
            to="/"
            className="block text-appDark-700 text-2xl font-bold uppercase relative"
          >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2 bg-appDark-700 text-appDark-50 border-none uppercase text-base font-bold mt-4 flex items-center justify-center disabled:opacity-40"
        >
          {loading ? (
